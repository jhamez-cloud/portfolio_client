...
export function Footer() {
  return (
      <footer className="bg-background/40 backdrop-blur-md border border-border/50 border-t py-12 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            {/* Brand */}
            <div>
              <h3 className="text-xl font-bold gradient-text mb-4">Portfolio</h3>
              <p className="text-foreground/70 text-sm">Creating exceptional digital experiences across all platforms</p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3 text-sm text-foreground/70">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <a href="tel:+233555530670" className="hover:text-accent transition-colors">
                    +233 5555 30670
                  </a>
                </div>
              </div>
