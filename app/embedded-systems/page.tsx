  ...
  const projects = [
    {
      ...
      tech: [
        ...
        { name: "MQTT", icon: <SiMqtt color="default" size={18} /> },
      ],
      link: "#",
    },
    {
      ...
      tech: [
        ...
        { name: "Python", icon: <SiPython color="default" size={18} /> },
        { name: "Sensors", icon: <SiShell color="default" size={18} /> },
      ],
      link: "#",
    },
    {
      ...
      tech: [
        { name: "Arduino", icon: <SiArduino color="default" size={18} /> },
        { name: "Servo Motors", icon: <SiShell color="default" size={18} /> },
        { name: "C++", icon: <SiCplusplus color="default" size={18} /> },
      ],
      link: "#",
    },
      ...
      <section className="py-20 px-4 gradient-primary">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl text-foreground/70 mb-12 max-w-2xl">
            Programming microcontrollers and IoT devices for real-world
            applications
          </p>
